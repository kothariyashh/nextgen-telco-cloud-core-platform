...
export function ApiKeyManager() {
  ...
  return (
    <section className="surface-card p-4">
      <h3 className="text-base font-semibold text-slate-900">API Key Management</h3>
      <p className="mt-1 text-sm text-slate-600">Create service keys for automation and external integrations.</p>
      ...
      {createdKey ? <p className="mt-2 rounded-lg bg-emerald-50 p-2 font-mono text-xs text-emerald-700">{createdKey}</p> : null}
    </section>
  );
}
